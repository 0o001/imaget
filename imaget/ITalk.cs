...
public class RectDrawing
{
    ...
    public class MonoFlat_ThemeContainer : ContainerControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            G.FillRectangle(new SolidBrush(Color.FromArgb(0, 102, 204)), new Rectangle(0, 0, Width, 40));
            ...
            if (_RoundCorners == true)
            {
                ...
                G.FillRectangle(new SolidBrush(Color.FromArgb(0, 102, 204)), 1, 3, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(0, 102, 204)), 1, 2, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(0, 102, 204)), 2, 1, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(0, 102, 204)), 3, 1, 1, 1);
                ...
                G.FillRectangle(new SolidBrush(Color.FromArgb(0, 102, 204)), Width - 2, 3, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(0, 102, 204)), Width - 2, 2, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(0, 102, 204)), Width - 3, 1, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(0, 102, 204)), Width - 4, 1, 1, 1);
                ...
                G.FillRectangle(new SolidBrush(Color.FromArgb(255, 255, 255)), 1, Height - 3, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(255, 255, 255)), 1, Height - 4, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(255, 255, 255)), 3, Height - 2, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(255, 255, 255)), 2, Height - 2, 1, 1);
                ...
                G.FillRectangle(new SolidBrush(Color.FromArgb(255, 255, 255)), Width - 2, Height - 3, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(255, 255, 255)), Width - 2, Height - 4, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(255, 255, 255)), Width - 4, Height - 2, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(255, 255, 255)), Width - 3, Height - 2, 1, 1);
            }
 
            G.DrawString(Text, new Font("Microsoft Sans Serif", 12, FontStyle.Bold), new SolidBrush(Color.FromArgb(255, 254, 255)), new Rectangle(10, 10, Width - 1, Height), new StringFormat() { Alignment = StringAlignment.Near, LineAlignment = StringAlignment.Near });
        }
    }
#endregion
                ...
                case iTalk_Toggle._Type.YesNo:
                    {
                        ...
                        if (toggled)
                        {
                            G.DrawString("Evet", new Font("Segoe UI", 7f, FontStyle.Regular), Brushes.Gray, (float)(this.Bar.X + 7), (float)this.Bar.Y, new StringFormat
                            {
                        ...
                        {
                            G.DrawString("Hayır", new Font("Segoe UI", 7f, FontStyle.Regular), Brushes.Gray, (float)(this.Bar.X + 18), (float)this.Bar.Y, new StringFormat
                            {
                                Alignment = StringAlignment.Center,
                                LineAlignment = StringAlignment.Center
                            });
                ...
                case iTalk_Toggle._Type.OnOff:
                    {
                        ...
                        if (toggled)
                        {
                            G.DrawString("Aç", new Font("Segoe UI", 7f, FontStyle.Regular), Brushes.Gray, (float)(this.Bar.X + 7), (float)this.Bar.Y, new StringFormat
                            {
                                Alignment = StringAlignment.Center,
                                LineAlignment = StringAlignment.Center
                            });
                        ...
                        {
                            G.DrawString("Kapat", new Font("Segoe UI", 7f, FontStyle.Regular), Brushes.Gray, (float)(this.Bar.X + 18), (float)this.Bar.Y, new StringFormat
                            {
                                Alignment = StringAlignment.Center,
                                LineAlignment = StringAlignment.Center
                            });
...
class iTalk_TextBox_Big : Control
{
    ...
    public Image Image
    {
        ...
        set
        {
            ...
            {
                iTalkTB.Location = new Point(42, 11);
            }
            Invalidate();
        }
    }
...
class MonoFlat_ControlBox : Control
{
    ...
    protected override void OnCreateControl()
    {
        ...
        try
        {
            Location = new Point(Parent.Width - 92, 1);
        }
        catch (Exception)
        {
        }
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        base.OnPaint(e);
        Graphics G = e.Graphics;
        G.Clear(Color.FromArgb(0, 102, 204));
        ...
        if (_EnableHoverHighlight == true)
        {
            switch (ButtonHState)
            {
                ...
                case ButtonHoverState.Minimize:
                    if (_EnableMinimize == true)
                    {
                        G.FillRectangle(new SolidBrush(Color.FromArgb(0, 102, 204)), new Rectangle(3, 0, 30, Height));
                    }
                    break;
                case ButtonHoverState.Maximize:
                    if (_EnableMaximize == true)
                    {
                        G.FillRectangle(new SolidBrush(Color.FromArgb(0, 102, 204)), new Rectangle(35, 0, 30, Height));
                    }
                    break;
                case ButtonHoverState.Close:
                    G.FillRectangle(new SolidBrush(Color.FromArgb(0, 102, 204)), new Rectangle(66, 0, 35, Height));
                    break;
            }
        }
